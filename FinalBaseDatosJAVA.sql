...
Insert into ADMINALMACEN.PRODUCTOSPEDIDO (IDPRODUCTOSPEDIDO,NOMBRE,IDFAMILIA,FECHAVENCIMIENTO,IDTIPOPRODUCTO,MARCA,CODIGOBARRA,DESCRIPCION,CANTIDAD,TOTALCOMPRA) values ('3','Detergente','1',to_date('27/11/22','DD/MM/RR'),'11','Omo','proveedor','Detergente Ideal para Lavar tu Ropa','50','75000');
...
Insert into ADMINALMACEN.PRODUCTOSPEDIDO (IDPRODUCTOSPEDIDO,NOMBRE,IDFAMILIA,FECHAVENCIMIENTO,IDTIPOPRODUCTO,MARCA,CODIGOBARRA,DESCRIPCION,CANTIDAD,TOTALCOMPRA) values ('10','Lechuga','4',to_date('27/11/22','DD/MM/RR'),'11','Vega','proveedor','Lechuga fresca para la ensalada','50','40000');
...
Insert into ADMINALMACEN.PRODUCTOSPEDIDO (IDPRODUCTOSPEDIDO,NOMBRE,IDFAMILIA,FECHAVENCIMIENTO,IDTIPOPRODUCTO,MARCA,CODIGOBARRA,DESCRIPCION,CANTIDAD,TOTALCOMPRA) values ('13','Corte Americano','5',to_date('27/11/22','DD/MM/RR'),'11','Carnes PF','proveedor','El mejor corte para la parrilla','15','37500');
Insert into ADMINALMACEN.PRODUCTOSPEDIDO (IDPRODUCTOSPEDIDO,NOMBRE,IDFAMILIA,FECHAVENCIMIENTO,IDTIPOPRODUCTO,MARCA,CODIGOBARRA,DESCRIPCION,CANTIDAD,TOTALCOMPRA) values ('14','Filete Vacuno','5',to_date('27/11/22','DD/MM/RR'),'11','Carnes PF','proveedor','El que siempre cae bien a toda la familia','30','60000');
...
Insert into ADMINALMACEN.PROVEEDOR (IDPROVEEDOR,NOMBRE,DATOSCONTACTO,RUBRO) values ('2','Distribuidora El Cielo','+56944343768','Licores');
...
SET DEFINE OFF;
Insert into ADMINALMACEN.USUARIO (IDUSUARIO,NOMBRE,CARGO,CONTRASENA) values ('1','user','Empleado','user');
Insert into ADMINALMACEN.USUARIO (IDUSUARIO,NOMBRE,CARGO,CONTRASENA) values ('2','admin','Admin','admin');
